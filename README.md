...
ReLU stands for Rectified Linear Unit, and despite the fancy name, its job is incredibly simple: it looks at the data passing through the network and turns any negative numbers into zeros, while leaving positive numbers exactly as they are.
...
There are two main reasons: spatial awareness and efficiency.
